...
class MsWordDocumentBackend(DeclarativeDocumentBackend):
    ...
    def _is_numbered_list(self, numId: int, ilvl: int) -> bool:
        ...
        try:
            ...
            num_fmt_element = lvl_element.find(".//w:numFmt", namespaces={"w": self._W_NS})
    ...
    def _get_level_text(self, numId: int, ilvl: int) -> Optional[str]:
        ...
        try:
            ...
            lvl_text_element = lvl_element.find(".//w:lvlText", namespaces={"w": self._W_NS})
    ...
    def _build_multi_level_marker(self, numid: int, ilevel: int, lvl_text: Optional[str]) -> str:
